...
<figure>
	<img src="{% asset_path 'articles/desk/plans.jpg' %}" class="img-fluid">
	<figcaption>
		Plans for my desk.
	</figcaption>
</figure>
...
<figure>
	<img src="{% asset_path 'articles/desk/mock_frame.jpg' %}" class="img-fluid">
	<figcaption>
		The frame all mocked up and cleaned.
	</figcaption>
</figure>
<figure>
	<img src="{% asset_path 'articles/desk/primed.jpg' %}" class="img-fluid">
	<figcaption>
...
<figure>
	<img src="{% asset_path 'articles/desk/painted.jpg' %}" class="img-fluid">
	<figcaption>
	The frame painted.
	</figcaption>
</figure>
...
### Theres more...
This is just part one of [two](/2013/02/13/building-my-desk-part-two-the-top/) posts outlining the construction of the frame and [top of my desk](/2013/02/13/building-my-desk-part-two-the-top/).
